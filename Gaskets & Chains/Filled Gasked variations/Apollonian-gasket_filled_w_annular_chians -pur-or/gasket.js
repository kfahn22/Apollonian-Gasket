...
class GasketCircle {
  ...
  show() {
    let col = color(75, 41, 107);
    let col2 = color(156, 227, 125);
    ...
    let mycol = lerpColor(
      col,
      col2,
      map(Math.log2(this.radius), 2, Math.log2(100), 1, 0)
    );
    //stroke(50, 41, 47, 200);
    stroke(254, 95, 85, 200);

    let sw = map(Math.log2(this.radius), 2, Math.log2(100), 0.3, 1);
    strokeWeight(sw);
    fill(mycol);
